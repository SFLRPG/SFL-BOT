// SFL-BOT 升級版 - 修復管理員權限版本
// 管理員指令 → 頻道ID: 1402338913258836108 (只有管理員可見)
// 一般指令 → 頻道ID: 1402341842023878697
// 自動監控 → 頻道ID: 1402338913258836108
...
console.log('🚀 SFL-BOT 自動監控版正在啟動（修復權限版本）...');
